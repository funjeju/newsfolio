    ...
    <div className="min-h-screen bg-background flex flex-col md:flex-row pb-20 md:pb-0">
      ...
      <aside className="w-64 border-r bg-card/50 backdrop-blur-md hidden md:flex flex-col z-20 sticky top-0 h-screen">
        ...
        <div className="p-4 border-t space-y-1">
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-slate-100/70 border border-border/50 mb-2">
          ...
          <Link
            href="/solo/settings"
            className="flex items-center gap-3 w-full px-3 py-2 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors rounded-xl hover:bg-slate-100/70"
          >
